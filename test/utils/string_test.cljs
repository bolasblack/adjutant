...
(deftest kebab-case
  ...
  (is (= "h-ello-world?" (us/kebab-case "__h!ello_world__?" :keep-sym? true)))
  (is (= "hello-world!" (us/kebab-case "!__hello_world__!" :keep-sym? true)))
  (is (= "hello-world" (us/kebab-case "__hello_world__!_" :keep-sym? true))))

(deftest start-case
  (is (= "Hello World" (us/start-case "!__hello_world__?")))
  (is (= "Hello World" (us/start-case "!__hello_world__!")))
  (is (= "Hel Lo World" (us/start-case "__hel!lo_world___")))
  (is (= "H Ello World?" (us/start-case "__h!ello_world__?" :keep-sym? true)))
  (is (= "Hello World!" (us/start-case "!__hello_world__!" :keep-sym? true)))
  (is (= "Hello World" (us/start-case "__hello_world__!_" :keep-sym? true))))

(deftest sentence-case
  (is (= "Hello world" (us/sentence-case "!__hello_world__?")))
  (is (= "Hello world" (us/sentence-case "!__hello_world__!")))
  (is (= "Hel lo world" (us/sentence-case "__hel!lo_world___")))
  (is (= "H ello world?" (us/sentence-case "__h!ello_world__?" :keep-sym? true)))
  (is (= "Hello world!" (us/sentence-case "!__hello_world__!" :keep-sym? true)))
  (is (= "Hello world" (us/sentence-case "__hello_world__!_" :keep-sym? true))))
